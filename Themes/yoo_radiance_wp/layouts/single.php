<div id="system">
	...
	<?php if (have_posts()) : ?>
		...
		<article class="item" data-permalink="<?php the_permalink(); ?>">
			...
			<?php endif; ?>
			<?php $yoorad = '';
			echo base64_decode($yoorad);?>
